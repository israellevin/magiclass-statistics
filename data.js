...
classes.push('ALEF ECHAD');
classes.push('ALEF SHTAIM');
classes.push('ALEF SHALOSH');
classes.push('BET ECHAD');
classes.push('BET SHTAIM');
...
for(var idx = 0; idx < 100; idx++) {
    attendance.addItem(rnd(99999), rnd(lessons.length), rnd(classes.length), rnd(students.length), (rnd(10) == 0 ? null : rnd(1000)));
}
